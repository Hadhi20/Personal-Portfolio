...
function downloadCV() {
  // Replace 'assets/cv/Hadhi_CV.pdf' with the actual path to your CV file
  const cvLink = 'assets/images/HadhiMR__Resume_w.pdf'; 

  // Create a temporary anchor element
  const link = document.createElement('a');
  link.href = cvLink;
  link.download = 'HadhiMR__Resume_w.pdf'; // The name of the file to download
